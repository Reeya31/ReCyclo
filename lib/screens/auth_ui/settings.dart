...
Future<void> updateWasteTypesInDatabase(List<String> selectedWasteTypes) async {
  try {
    String? userId = FirebaseAuth.instance.currentUser?.uid;
...
final List<String> wasteTypeOptions = ["Plastic", "Paper", "Glass", "e-Waste"];

// Update the updateUserInfoInDatabase function to handle List<bool>
Future<void> updateUserInfoInDatabase(List<bool> newValues,
    {required String userId, required String userType, required String inputType}) async {
  try {
